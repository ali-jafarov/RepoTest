using System;
using HomeWorkStudents;

namespace HomeWorkStudents
{
  public class Menu
  {
    ...
    public Student CreateStudent()
    {
      ...
      if (int.TryParse(input, out var year) && year > 0 && year < 5)
      {
        ...
        return new Student(name, year, docNumber);
      }
    ...
    public Aspirant CreateAspirant()
    {
      ...
      if (int.TryParse(input, out var year) && year > 0 && year < 5)
      {
        ...
        return new Aspirant(name, year, docNumber, diplom);
      }
...
public class Student
{
  ...
  public Student(string name, int year, string docNumber)
  {
    this.name = name;
    this.year = year;
  ...
  public string Print()
  {
    return $"Имя: {Name}, Документ: {DocNumber}, Курс: {Year}";
  }
}
public class Aspirant : Student
{
  ...
  public Aspirant(string name, int year, string docNumber, string diplom) : base(name, year, docNumber)
  {
    this.diplom = diplom;
  }
  ...
  public string Print()
  {
    return base.Print() + $", Тема дипломной работы: {diplom}";
  }
  class Program
  {
